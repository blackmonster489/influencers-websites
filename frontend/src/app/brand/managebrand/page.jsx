      ...
      <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        <thead className="bg-gray-50 dark:bg-gray-800">
          <tr>
            ...
            <th scope="col" colSpan={2} className="relative py-3.5 px-4">
            ...
            return (
              <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                <tr>
                  ...
                  <td className="px-4 py-4 text-sm whitespace-nowrap align-top">
                    <Link href={"/brand/manage-enrolled/"+info._id} class="focus:outline-none text-white bg-red-800 hover:bg-yellow-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-red-700 dark:focus:ring-green-800">View Enrollments</Link>
                  </td>
                </tr>
