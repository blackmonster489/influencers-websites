...
const page = () => {
  return (
    <div>
        <div>
    <label for="file" class="block text-sm text-gray-500 dark:text-gray-300"></label>

    <label for="dropzone-file" class="flex flex-col items-center w-full max-w-lg p-5 mx-auto mt-5 text-center bg-white border-2 border-gray-300 border-dashed cursor-pointer dark:bg-gray-900 dark:border-gray-700 rounded-xl">
    ...
    <h1 className={classes.text}>Upload your brand logo</h1>
</div>
    </div>
  )
}
