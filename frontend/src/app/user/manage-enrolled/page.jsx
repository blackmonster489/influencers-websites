                ...
                <td className="px-4 py-4 text-sm whitespace-nowrap">
                  <div>
                    <h4 className="text-gray-700 dark:text-gray-200">
                        Aurora skincare & Beauty<br/>
                        "Empowering Your Beauty, Inside and Out."<br/>

                        "Ready to Inspire? Collaborate with Aurora skin care and beauty and U…"
                    </h4>
