          ...
          <div className="lg:flex">
            <div className="lg:w-1/2">
              <img
                ...
                alt=""
              />
              <h1 className="mt-4 text-white dark:text-gray-300 md:text-lg">
                Welcome back
              </h1>
              <h1 className="mt-4 text-2xl font-medium text-white capitalize lg:text-3xl dark:text-white">
                ...
                <div className="relative">
                  <span className="absolute">
                    <svg
                      ...
                      className="w-6 h-6 mx-3 mt-3 text-gray-300 dark:text-gray-500"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={2}
                  ...
                  />
                  {
                    loginForm.touched.email && <small className='text-red-300'>
