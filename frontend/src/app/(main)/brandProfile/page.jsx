...
const page = () => {
  ...
  <div className="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <form>
      {/* Card */}
      <div className="bg-black rounded-xl shadow dark:bg-neutral-900">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-2">
              <label
                ...
                className="inline-block text-sm font-semibold text-white mt-2.5 dark:text-neutral-200"
              >
                Brand name
              </label>
              <input
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <span className="mt-2 block text-sm text-white dark:text-neutral-200">
                  Browse your device or{" "}
                  <span className="group-hover:text-blue-300 text-blue-300">
                    drag 'n drop'
                  </span>
                </span>
                <span className="mt-1 block text-xs text-gray-200 dark:text-neutral-500">
