    ...
    <div className="lg:flex lg:items-center">
      ...
      <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
        <img
          ...
          src="https://ideogram.ai/api/images/direct/N6Vnh7rOQKa3bQjRR9JG9A.png"
          alt=""
        />
      </div>
    </div>
...
<section className="bg-gray-800 dark:bg-gray-900">
  <div className="container px-6 py-10 mx-auto">
    <i> <h1 className="text-2xl font-bold text-center text-white capitalize lg:text-5xl dark:text-white">
      Lets Collab
    </h1>
</i>
    ...
    <div className="flex items-center justify-center">
      <div className="flex items-center p-1 border border-blue-300 dark:border-blue-400 rounded-xl">
        < a href="browse-influencer"><button className="px-4 py-2 text-sm font-medium text-white capitalize bg-blue-600 md:py-3 rounded-xl md:px-12">
          Influencers
        </button>
      </a>
        <a href="/browse-campaign"><button className="px-4 py-2 mx-4 text-sm font-medium text-blue-600 capitalize transition-colors duration-300 md:py-3 dark:text-blue-400 dark:hover:text-white focus:outline-none hover:bg-blue-600 hover:text-white rounded-xl md:mx-8 md:px-12">
          Brands Campaign
        </button>
      </a>
      </div>
