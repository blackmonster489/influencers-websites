...
const signupForm= () => {
  const signupValidationSchema = Yup.object().shape({
    ...
    password: Yup.string().required('Password is Required').min(6, 'Password is Too Short')
      ...
      .matches(/[0-9]/, 'phoneNumber must contain numbers'),
  });
  ...
  <div className="max-w-4xl px-4 py-10 sm:px-6 lg:px-8 mx-auto">
    {/* Card */}
    <div className="bg-black rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-800">
      <div className="mb-8">
      ...
      <form>
            ...
            <div className="sm:flex">
              ...
              >
                <input
                  ...
                  onChange={signupForm.handleChange}
              value={signupForm.values.gendermale}
                  ...
                  defaultChecked=""
                />
                <span className="text-sm text-gray-200 ms-3 dark:text-neutral-400">
                  Male
                </span>
              </label>
              <label
              ...
              >
                <input
                  ...
                  name="af-account-gender-checkbox"
                  onChange={signupForm.handleChange}
              value={signupForm.values.genderfemale}
                  className="shrink-0 mt-0.5 border-gray-300 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-500 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
              ...
              >
                <input
                  ...
                  name="af-account-gender-checkbox"
                  onChange={signupForm.handleChange}
              value={signupForm.values.genderother}
                  className="shrink-0 mt-0.5 border-gray-300 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-500 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
        ...
        <div className="mt-5 flex justify-end gap-x-2">
          <button
            type="button"
            onChange={signupForm.handleChange}
              value={signupForm.values.cancel}
            className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800"
          >
            Cancel
          </button>
          <button
            type="submit"
            onChange={signupForm.handleChange}
              value={signupForm.values.savechanges}
