...
const page = () => {
  ...
  <div className="container px-6 py-10 mx-auto">
    ...
    <div className="flex py-4 mt-4 overflow-x-auto overflow-y-hidden md:justify-center dark:border-gray-700">
      <button className="h-12 px-8 py-2 -mb-px text-sm text-center text-blue-800 font-bold bg-transparent border-b-2 border-blue-500 sm:text-base dark:border-blue-400 dark:text-blue-300 whitespace-nowrap focus:outline-none">
        Add Campaign
      </button>
...
<section className={classes.sections1}>
    ...
    <button className={classes.btn}><b>Add Campaigns</b></button> 
